...
const accountItems = [
  ...
  },
  {
    ...
    title: "industrial & skilled trades",
    href: "/signup"
  },
  {
    title: "supervision & industrial management",
    href: "/signup"
  },
  {
    ...
    >
      <div className="relative mx-auto flex items-center text-blue-gray-900">
        <Typography
          as="a"
          href="/"
          className="mr-4 ml-2 cursor-pointer py-1.5 font-medium fw-500"  
        >
          Diasha
        </Typography>
