      ...
      <div className="container mx-auto">
        ...
        >
          <CardBody className="md:py-20 md:px-14 md:w-7/12">
            ...
            Gain a deeper understanding of talent scarcity, the factors driving it, and the impact it has on the global economy. Our comprehensive report provides valuable insights for employers, employees, and policymakers as they navigate the challenges of talent shortages.
            </Typography>
